...
?>
            <section id="special-price">
                <div class="container">
                    ...
                    <div id="filters" class="button-group d-flex justify-content-end font-Montserrat font-size-16">
                        ...
                        <div class="grid-item <?= $item["item_brand"] ?? "brand" ?> border">
                            <div class="item py-2" style="width: 200px;">
                                <div class="product font-rale">
                                    <a href="<?php printf('./%s?item_id=%s','product.php', $item['item_id'])?>"><img src="<?= $item['item_image'] ?? "./assets/products/1.png" ?>" alt="product13" class="img-fluid"></a>
